...
import static demoweb_shop.BasePage.driver;

public class Mapping_product_price {
...
//            WebElement txtbx_search_result_text = driver.findElement(By.xpath("//span[contains(text(),'Showing 1 – 24 of 1,248 results for ')]"));
...
//            Reporter.log("Search Box set with value :" + s_search_string + " and search results displayed" + "<br>", true);
            ...
            List<WebElement> list_of_products = driver.findElements(By.xpath("//div[@class='_1YokD2 _3Mn1Gg']//following::div[@class='_4rR01T']"));
            List<WebElement> list_of_products_price = driver.findElements(By.xpath("//div[@class='_1YokD2 _3Mn1Gg']//following::div[@class='_30jeq3 _1_WHN1']"));
            ...
            //Find the Highest and Lowest pricesso
